    ...
    <div className="page">
      ...
      >
        <svg viewBox="0 0 24 24">
          <path d="M.057 24l1.687-6.163c-1.041-1.804-1.588-3.849-1.587-5.946C.06 5.348 5.397.01 12.008.01c3.202.001 6.212 1.246 8.477 3.513 2.262 2.268 3.507 5.28 3.505 8.484-.004 6.657-5.34 11.997-11.953 11.997-2.005-.001-3.973-.502-5.724-1.455L0 24zm6.59-4.846c1.6.95 3.188 1.449 4.725 1.451 5.436 0 9.86-4.42 9.864-9.858.002-2.635-1.023-5.11-2.885-6.974C16.488 1.808 14.016.784 11.38.784c-5.443 0-9.87 4.422-9.873 9.86-.001 2.016.528 3.988 1.533 5.728l-.953 3.48 3.56-.933zm12.167-4.81c-.262-.13-1.554-.767-1.793-.853-.239-.087-.413-.13-.588.13-.175.26-.677.852-.83 1.026-.153.174-.306.195-.568.064-.262-.13-1.103-.407-2.102-1.3-.777-.693-1.302-1.55-1.455-1.812-.153-.262-.016-.404.116-.534.12-.117.262-.305.393-.456.13-.153.175-.262.262-.436.087-.175.044-.326-.022-.456-.066-.13-.588-1.417-.807-1.947-.213-.515-.446-.443-.608-.451-.157-.008-.337-.01-.518-.01-.18 0-.476.068-.724.34-.248.271-.947.926-.947 2.259 0 1.333.97 2.622 1.106 2.805.135.183 1.908 2.913 4.623 4.082.645.278 1.149.444 1.543.569.648.206 1.238.177 1.704.108.52-.078 1.554-.635 1.772-1.25.218-.615.218-1.14.153-1.25-.065-.11-.239-.175-.501-.305z" />
        </svg>
      </a>
    </div>
  );
